...
6. Nhấn "Tính toán" để xem kết quả`),
    ...
    tags: ['HVAC', 'điều hòa', 'tính toán', 'BTU', 'tiết kiệm năng lượng'],
    featured: true,
    status: 'published',
    language: 'vi',
    targetAudience: ['kỹ sư HVAC', 'nhà thầu', 'chủ nhà'],
    relatedTools: ['efficiency-comparison', 'energy-savings-analysis'],
    seoTitle: 'Công cụ tính toán tải lạnh - Xác định công suất điều hòa phù hợp',
    seoDescription: 'Tính toán chính xác công suất điều hòa cần thiết cho không gian của bạn. Công cụ miễn phí, dễ sử dụng với kết quả chi tiết.',
