    ...
    const posts = [
      {
        ...
        slug: "tieu-chuan-moi-ve-hieu-suat-nang-luong",        publishedAt: new Date("2025-05-10").toISOString(),
        status: "published",
        _status: "published",
      ...
      },
      {
        ...
        slug: "cong-nghe-moi-trong-he-thong-lanh-2025",        publishedAt: new Date("2025-04-15").toISOString(),
        status: "published",
        _status: "published",
        heroImage: defaultMediaId,
      ...
      },
      {
        ...
        slug: "vrc-hoan-thanh-du-an-lon-tai-khu-cong-nghiep-long-thanh",        publishedAt: new Date("2025-05-01").toISOString(),
        status: "published",
        _status: "published",
        heroImage: defaultMediaId,
