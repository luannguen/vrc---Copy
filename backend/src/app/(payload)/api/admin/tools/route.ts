...
import { handleGET } from '../../tools/handlers/get';
import { handlePOST } from '../../tools/handlers/post';
import { handleDELETE } from '../../tools/handlers/delete';
import { handleOPTIONS } from '../../tools/handlers/options';
import { handlePatch } from '../../tools/handlers/patch';
import { handlePUT } from '../../tools/handlers/put';

/**
 * Admin Tools API Routes
 * This API provides admin panel integration for the Tools collection
 * These routes are specifically for PayloadCMS admin panel operations
 *
