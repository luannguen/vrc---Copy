import { ArrowLeft, ArrowRight, Calendar, Clock, MapPin, CheckCircle, Loader2, Building2 } from "lucide-react";
...
const CommercialProjects = () => {
  // Fetch commercial projects and settings
  const { projects, loading, error } = useProjects({ category: 'commercial' });
      ...
      <main className="flex-grow">
        ...
        <div className="bg-primary text-white py-12 md:py-16">
          <div className="container mx-auto px-4">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold">Dự Án Hệ Thống Làm Lạnh Thương Mại</h1>
            <p className="mt-4 text-lg max-w-3xl">
              Các dự án tiêu biểu về hệ thống làm lạnh thương mại mà VRC đã triển khai thành công cho các tòa nhà văn phòng, trung tâm thương mại và khách sạn
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto py-12 px-4">
          ...
          <section className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-8">Dự án thương mại tiêu biểu</h2>
            ...
            {projects.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-600">Hiện tại chưa có dự án thương mại nào.</p>
              </div>
            )}
          </section>          
          {/* CTA Section */}
          <div className="bg-primary/10 rounded-lg p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-4">
                {pageSettings?.ctaSection?.title || "Bạn cần tư vấn về dự án thương mại?"}
              </h2>
              <p className="text-muted-foreground mb-6">
                {pageSettings?.ctaSection?.description || 
                 "Đội ngũ kỹ sư giàu kinh nghiệm của VRC sẵn sàng hỗ trợ bạn thiết kế, lắp đặt và bảo trì hệ thống làm lạnh thương mại phù hợp với nhu cầu cụ thể của doanh nghiệp."}
              </p>
              <div className="flex flex-wrap gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" asChild>
                  <Link to={pageSettings?.ctaSection?.secondaryButton?.link || "/products/commercial"}>
                    {pageSettings?.ctaSection?.secondaryButton?.text || "Xem sản phẩm thương mại"}
                  </Link>
                </Button>
              </div>
            </div>
