  ...
  if (isMobile) {
    return (
      <nav className="flex flex-col space-y-4">
        ...
        <AppLink routeKey="NEWS" className="navbar-link text-lg">News</AppLink>
        <AppLink routeKey="EVENTS" className="navbar-link text-lg">Events</AppLink>
      </nav>
    );
  }
      ...
      <div className="relative group">
        ...
        <div className="absolute hidden group-hover:block bg-white/10 backdrop-blur-sm shadow-lg p-4 rounded min-w-40 right-0">
          <div className="flex flex-col space-y-2">
            <AppLink routeKey="NEWS" className="text-primary hover:text-accent text-base">News</AppLink>
            <AppLink routeKey="EVENTS" className="text-primary hover:text-accent text-base">Events</AppLink>
          </div>
        </div>
      </div>
    </nav>
